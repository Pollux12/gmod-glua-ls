...
mod test {
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_before_client_reader_has_no_nil_access_diagnostic()
    {
        let mut ws = gmod_ws();
        ws.def_file(
        ...
        let reader = ws.def_file(
            "lua/autorun/client/cl_late_reader.lua",
            r#"
    ...
    #[gtest]
    fn test_outer_numeric_range_population_before_reader_has_no_nil_access_diagnostic() {
        let mut ws = gmod_ws();
        ws.def_file(
    ...
    #[gtest]
    fn test_outer_numeric_range_population_multiple_tables_and_mode_args_has_no_nil_access_diagnostic()
     {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/a_colors.lua",
        ...
        let reader = ws.def_file(
            ...
            r#"
            ROLE_COLORS[ROLE_TRAITOR].r = 1
            ROLE_COLORS_DARK[ROLE_TRAITOR].r = 1
        "#,
        );
    ...
    fn test_outer_numeric_range_population_defined_but_not_called_stays_need_check_nil() {
        ...
        ws.def_file(
            ...
            ROLE_TRAITOR = 2
            ROLE_COLORS = {}
            local function fill(list) for i = ROLE_MIN, ROLE_MAX do list[i] = { r = 1 } end end
            function update() fill(ROLE_COLORS) end
        "#,
        );
        let reader = ws.def_file(
    ...
    #[gtest]
    fn test_outer_numeric_range_population_call_after_reader_stays_need_check_nil() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/a_colors.lua",
            r#"
        ...
        ws.def_file("lua/autorun/shared/c_update.lua", "update()");

        assert_that!(need_check_nil_for_file(&mut ws, reader), len(eq(1)));
    }

    #[gtest]
    fn test_outer_numeric_range_population_nested_call_stays_need_check_nil() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/a_colors.lua",
            r#"
    ...
    #[gtest]
    fn test_outer_numeric_range_population_unknown_call_between_fills_stays_need_check_nil() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/a_colors.lua",
            r#"
            ...
            ROLE_COLORS = {}
            local function fill(list) for i = ROLE_MIN, ROLE_MAX do list[i] = { r = 1 } end end
            function update() unknown() fill(ROLE_COLORS) end
            update()
        "#,
        );
        let reader = ws.def_file(
    ...
    #[gtest]
    fn test_outer_numeric_range_population_reset_after_fill_stays_need_check_nil() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/a_colors.lua",
            r#"
            ...
            ROLE_COLORS = {}
            local function fill(list) for i = ROLE_MIN, ROLE_MAX do list[i] = { r = 1 } end end
            function update() fill(ROLE_COLORS) ROLE_COLORS = {} end
            update()
        "#,
        );
        let reader = ws.def_file(
    ...
    #[gtest]
    fn test_outer_numeric_range_population_outer_reassigned_before_call_stays_need_check_nil() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/a_colors.lua",
            r#"
    ...
    #[gtest]
    fn test_outer_numeric_range_population_fill_reassigned_before_call_stays_need_check_nil() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/a_colors.lua",
            r#"
    ...
    #[gtest]
    fn test_outer_numeric_range_population_local_fill_shadow_before_call_stays_need_check_nil() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/a_colors.lua",
            r#"
    ...
    #[gtest]
    fn test_outer_numeric_range_population_fill_mutated_inside_outer_stays_need_check_nil() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/a_colors.lua",
            r#"
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_intervening_ordered_mutation_stays_need_check_nil()
    {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/a_colors.lua",
        ...
        ws.def_file(
            "lua/autorun/shared/b_mutate_colors.lua",
            r#"
            ROLE_COLORS[ROLE_TRAITOR] = nil
        "#,
        );
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_local_reassignment_after_initializer_stays_need_check_nil()
     {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/a_colors.lua",
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_function_scope_mutation_before_direct_read_stays_need_check_nil()
     {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/a_colors.lua",
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_function_scope_root_replacement_before_direct_read_stays_need_check_nil()
     {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/a_colors.lua",
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_branch_local_client_read_uses_read_realm() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/a_colors.lua",
            r#"
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_top_level_root_replacement_before_nested_read_stays_need_check_nil()
     {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/a_colors.lua",
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_top_level_unknown_call_before_nested_read_stays_need_check_nil()
     {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/a_colors.lua",
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_top_level_root_replacement_after_nested_read_definition_stays_need_check_nil()
     {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/a_colors.lua",
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_top_level_unknown_call_after_nested_read_definition_stays_need_check_nil()
     {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/a_colors.lua",
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_if_condition_call_before_read_stays_need_check_nil()
    {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/a_colors.lua",
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_disjoint_writes_global_call_preserves_fact() {
        let mut ws = gmod_ws();
        ...
        let reader = ws.def_file(
            "lua/autorun/shared/c_reader.lua",
            r#"
            ---@[writes_global("OtherCache")]
            function TouchOther() end
            TouchOther()
            local c=ROLE_COLORS[ROLE_TRAITOR]
            c.r=1
            "#,
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_matching_writes_global_call_rejects_fact() {
        let mut ws = gmod_ws();
        ws.def_file("lua/autorun/shared/a_colors.lua", r#"ROLE_MIN=1 ROLE_MAX=3 ROLE_TRAITOR=2 ROLE_COLORS={} local function fill(list) for i=ROLE_MIN,ROLE_MAX do list[i]={r=1} end end fill(ROLE_COLORS)"#);
        let reader = ws.def_file(
            "lua/autorun/shared/c_reader.lua",
            r#"
            ---@[writes_global("ROLE_COLORS")]
            function TouchColors() end
            TouchColors()
            local c=ROLE_COLORS[ROLE_TRAITOR]
            c.r=1
            "#,
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_alias_root_writes_global_call_rejects_fact() {
        let mut ws = gmod_ws();
        ws.def_file("lua/autorun/shared/a_colors.lua", r#"ROLE_MIN=1 ROLE_MAX=3 ROLE_TRAITOR=2 ROLE_COLORS={} ROLE_COLORS_ALIAS=ROLE_COLORS local function fill(list) for i=ROLE_MIN,ROLE_MAX do list[i]={r=1} end end fill(ROLE_COLORS_ALIAS)"#);
        let reader = ws.def_file(
            "lua/autorun/shared/c_reader.lua",
            r#"
            ---@[writes_global("ROLE_COLORS_ALIAS")]
            function TouchAlias() end
            TouchAlias()
            local c=ROLE_COLORS[ROLE_TRAITOR]
            c.r=1
            "#,
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_include_call_rejects_fact() {
        let mut ws = gmod_ws();
        ws.def_file("lua/autorun/shared/a_colors.lua", r#"ROLE_MIN=1 ROLE_MAX=3 ROLE_TRAITOR=2 ROLE_COLORS={} local function fill(list) for i=ROLE_MIN,ROLE_MAX do list[i]={r=1} end end fill(ROLE_COLORS)"#);
        let reader = ws.def_file(
            "lua/autorun/shared/c_reader.lua",
            r#"include("x.lua") local c=ROLE_COLORS[ROLE_TRAITOR] c.r=1"#,
        );
        assert_that!(need_check_nil_for_file(&mut ws, reader), len(eq(1)));
    }

    #[gtest]
    fn test_cross_file_numeric_range_population_local_shadow_effect_function_rejects_fact() {
        let mut ws = gmod_ws();
        ws.def_file("lua/autorun/shared/a_colors.lua", r#"ROLE_MIN=1 ROLE_MAX=3 ROLE_TRAITOR=2 ROLE_COLORS={} local function fill(list) for i=ROLE_MIN,ROLE_MAX do list[i]={r=1} end end fill(ROLE_COLORS)"#);
        let reader = ws.def_file(
            "lua/autorun/shared/c_reader.lua",
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_nested_closure_call_does_not_reject_fact() {
        let mut ws = gmod_ws();
        ws.def_file("lua/autorun/shared/a_colors.lua", r#"ROLE_MIN=1 ROLE_MAX=3 ROLE_TRAITOR=2 ROLE_COLORS={} local function fill(list) for i=ROLE_MIN,ROLE_MAX do list[i]={r=1} end end fill(ROLE_COLORS)"#);
        let reader = ws.def_file("lua/autorun/shared/c_reader.lua", r#"local later=function() UnknownMutator() end local c=ROLE_COLORS[ROLE_TRAITOR] c.r=1"#);
        assert_that!(need_check_nil_for_file(&mut ws, reader), len(eq(0)));
    }

    #[gtest]
    fn test_cross_file_numeric_range_population_malformed_writes_global_call_rejects_fact() {
        let mut ws = gmod_ws();
        ws.def_file("lua/autorun/shared/a_colors.lua", r#"ROLE_MIN=1 ROLE_MAX=3 ROLE_TRAITOR=2 ROLE_COLORS={} local function fill(list) for i=ROLE_MIN,ROLE_MAX do list[i]={r=1} end end fill(ROLE_COLORS)"#);
        let reader = ws.def_file(
            "lua/autorun/shared/c_reader.lua",
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_helper_reassignment_before_population_call_stays_need_check_nil()
     {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/a_colors.lua",
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_helper_local_shadow_before_population_call_stays_need_check_nil()
     {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/a_colors.lua",
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_helper_conditional_reassignment_before_population_call_stays_need_check_nil()
     {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/a_colors.lua",
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_pre_call_can_mutate_helper_upvalue_stays_need_check_nil()
     {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/a_colors.lua",
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_conditional_pre_call_can_mutate_helper_upvalue_stays_need_check_nil()
     {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/a_colors.lua",
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_suffix_mutation_in_population_file_stays_need_check_nil()
     {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/a_colors.lua",
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_intervening_conditional_mutation_stays_need_check_nil()
     {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/a_colors.lua",
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_intervening_conditional_call_stays_need_check_nil()
    {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/a_colors.lua",
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_function_defined_but_not_called_stays_need_check_nil()
     {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_reader_before_population_stays_need_check_nil() {
        let mut ws = gmod_ws();
        let reader = ws.def_file(
            "lua/autorun/shared/a_reader.lua",
            "ROLE_TRAITOR = 2\nlocal c = ROLE_COLORS[ROLE_TRAITOR]\nc.r = 1",
        );
        ws.def_file(
            "lua/autorun/shared/z_colors.lua",
            r#"
            ROLE_MIN = 1
            ROLE_MAX = 3
            ROLE_COLORS = {}
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_inside_uncalled_function_stays_need_check_nil() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
            r#"
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_out_of_range_key_stays_need_check_nil() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
            "ROLE_MIN = 1\nROLE_MAX = 3\nROLE_SERIAL = 4\nROLE_COLORS = {}\nlocal function fill(list)\n for i = ROLE_MIN, ROLE_MAX do list[i] = { r = 1 } end\nend\nfill(ROLE_COLORS)",
        );
        let reader = ws.def_file(
            "lua/autorun/client/cl_late_reader.lua",
            "local c = ROLE_COLORS[ROLE_SERIAL]\nc.r = 1",
        );
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_dynamic_key_stays_need_check_nil() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
            "ROLE_MIN = 1\nROLE_MAX = 3\nROLE_COLORS = {}\nlocal function fill(list)\n for i = ROLE_MIN, ROLE_MAX do list[i] = { r = 1 } end\nend\nfill(ROLE_COLORS)",
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_key_reassigned_before_read_stays_need_check_nil() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
            "ROLE_MIN = 1\nROLE_MAX = 3\nROLE_TRAITOR = 2\nROLE_COLORS = {}\nlocal function fill(list)\n for i = ROLE_MIN, ROLE_MAX do list[i] = { r = 1 } end\nend\nfill(ROLE_COLORS)",
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_root_replaced_before_read_stays_need_check_nil() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
            "ROLE_MIN = 1\nROLE_MAX = 3\nROLE_TRAITOR = 2\nROLE_COLORS = {}\nlocal function fill(list)\n for i = ROLE_MIN, ROLE_MAX do list[i] = { r = 1 } end\nend\nfill(ROLE_COLORS)",
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_compatible_mutation_before_read_stays_need_check_nil()
     {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_nullable_or_call_rhs_stays_need_check_nil() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_safe_rhs_call_has_no_nil_access_diagnostic() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
            r#"
            ...
            ---@param color table?
            local function fill(list, color, mode)
                for i = ROLE_MIN, ROLE_MAX do
                    list[i] = ModifyColor(color or COLOR_WHITE, mode)
                end
            end

            ---@type table?
            local maybe = nil
            fill(ROLE_COLORS, maybe, "normal")
        "#,
        );
        let reader = ws.def_file(
            "lua/autorun/client/cl_late_reader.lua",
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_safe_rhs_call_or_fallback_actual_has_no_nil_access()
    {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
            ...
            ---@param color table?
            local function fill(list, color)
                for i = ROLE_MIN, ROLE_MAX do
                    list[i] = fallback(color or COLOR_WHITE)
                end
            end

            ---@type table?
            local maybe = nil
            fill(ROLE_COLORS, maybe)
        "#,
        );
        let reader = ws.def_file(
            "lua/autorun/client/cl_late_reader.lua",
    ...
    fn test_cross_file_numeric_range_population_nested_call_has_no_nil_access() {
        ...
        ws.def_file(
            ...
            local function fill(list)
                for i = ROLE_MIN, ROLE_MAX do list[i] = MakeBaseColor() end
            end
            fill(ROLE_COLORS)
        "#,
        );
    ...
    fn test_cross_file_numeric_range_population_nested_arg_has_no_nil_access() {
        ...
        ws.def_file(
            ...
            local function fill(list)
                for i = ROLE_MIN, ROLE_MAX do list[i] = TintColor(MakeBaseColor()) end
            end
            fill(ROLE_COLORS)
        "#,
        );
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_writes_global_private_cache_has_no_nil_access() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
            r#"
            ...
            ---@return table
            ---@[writes_global("PrivateCache")]
            function GetCachedColor()
                return { r = 1 }
            end

            local function fill(list)
                for i = ROLE_MIN, ROLE_MAX do list[i] = GetCachedColor() end
            end
            fill(ROLE_COLORS)
        "#,
        );
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_writes_global_table_root_stays_need_check_nil() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
            r#"
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_writes_global_key_constant_stays_need_check_nil() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
            r#"
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_writes_global_unknown_arg_call_stays_need_check_nil()
     {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
            ...
            ---@return table
            ---@[writes_global("PrivateCache")]
            function GetCachedColor(seed)
                return { r = 1 }
            end

            local function fill(list)
                for i = ROLE_MIN, ROLE_MAX do list[i] = GetCachedColor(UnknownCall()) end
            end
            fill(ROLE_COLORS)
        "#,
        );
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_writes_global_name_shadow_stays_need_check_nil() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
            r#"
            ...
            local function fill(list)
                local GetCachedColor = function() return { r = 1 } end
                for i = ROLE_MIN, ROLE_MAX do list[i] = GetCachedColor() end
            end
            fill(ROLE_COLORS)
        "#,
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_preloop_helper_writes_key_stays_need_check_nil() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
            r#"
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_branch_condition_writes_key_stays_need_check_nil() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
            r#"
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_local_rhs_helper_with_safe_nested_calls_has_no_nil_access()
     {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
            ...
            ---@return table
            local function ModifyColor(color)
                return ColorAlpha(color, 255)
            end

            local function fill(list)
                for i = ROLE_MIN, ROLE_MAX do list[i] = ModifyColor(Color(1, 2, 3)) end
            end
            fill(ROLE_COLORS)
        "#,
        );
    ...
    fn test_cross_file_numeric_range_population_outer_helper_with_unbodied_library_call_stays_need_check_nil()
     {
        ...
        ws.def_files(vec![
            (
                "lua/includes/glua_ls_gmod_color_builtins.lua",
                r#"
            ---@class Color
        ...
        "#,
            ...
            local function ModifyColor(color, mode)
                if mode == "hsl" then
                    return HSLToColor(0, 0, 1)
                end

                return color
            end

            local function FillRoleColors(list, mode)
                for i = ROLE_MIN, ROLE_MAX do
                    list[i] = ModifyColor(COLOR_WHITE, mode)
                end
            end

            local function UpdateRoleColours()
                FillRoleColors(ROLE_COLORS, "hsl")
            end
        ...
        let reader = ws.def_file(
            "lua/autorun/client/cl_reader.lua",
            "local c = ROLE_COLORS[ROLE_TRAITOR]\nc.r = 1",
        );
    ...
    fn test_cross_file_numeric_range_population_library_workspace_unbodied_call_stays_need_check_nil()
     {
        ...
        let library_root = ws
            .virtual_url_generator
            .new_path("__test_gmod_color_library");
        ws.analysis.add_library_workspace(library_root.clone());
        let library_uri =
    ...
    fn test_cross_file_numeric_range_population_local_shadowed_library_stays_need_check_nil() {
        ...
        "#,
            ...
            local function ModifyColor(color, mode)
                local HSLToColor = function(h, s, l) return color end
                return HSLToColor(0, 0, 1)
            end
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_local_rhs_helper_unknown_nested_call_stays_need_check_nil()
     {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_local_rhs_helper_cycle_stays_need_check_nil() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
            r#"
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_rhs_helper_param_reassign_stays_need_check_nil() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
            r#"
            ...
            local function fill(list)
                for i = ROLE_MIN, ROLE_MAX do list[i] = ModifyColor(COLOR_WHITE) end
            end
            fill(ROLE_COLORS)
        "#,
        );
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_rhs_helper_conditional_param_reassign_stays_need_check_nil()
     {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
            ...
            local function fill(list)
                for i = ROLE_MIN, ROLE_MAX do list[i] = ModifyColor(COLOR_WHITE, "hsl") end
            end
            fill(ROLE_COLORS)
        "#,
        );
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_rhs_helper_param_local_shadow_stays_need_check_nil()
    {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_unknown_nested_call_stays_need_check_nil() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
            r#"
            ...
            ROLE_COLORS = {}
            local function fill(list)
                for i = ROLE_MIN, ROLE_MAX do list[i] = UnknownColor() end
            end
            fill(ROLE_COLORS)
        "#,
        );
    ...
    fn test_cross_file_numeric_range_population_unknown_arg_call_stays_need_check_nil() {
        ...
        ws.def_file(
            ...
            local function fill(list)
                for i = ROLE_MIN, ROLE_MAX do list[i] = TintColor(UnknownColor()) end
            end
            fill(ROLE_COLORS)
        "#,
        );
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_nullable_rhs_helper_call_stays_need_check_nil() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
            r#"
            ...
            ---@return table?
            local function MaybeColor() end
            local function passthrough(color) return color end
            local function fill(list)
                for i = ROLE_MIN, ROLE_MAX do list[i] = passthrough(MaybeColor()) end
            end
            fill(ROLE_COLORS)
        "#,
        );
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_rhs_helper_mutates_root_stays_need_check_nil() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
            r#"
            ...
            local function fill(list)
                for i = ROLE_MIN, ROLE_MAX do list[i] = MakeColor() end
            end
            fill(ROLE_COLORS)
        "#,
        );
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_rhs_helper_alias_index_write_stays_need_check_nil()
    {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_rhs_helper_param_index_write_stays_need_check_nil()
    {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
            ...
            ROLE_TRAITOR = 2
            ROLE_COLORS = {}
            local function MakeColor(t)
                t[ROLE_TRAITOR] = nil
                return { r = 1 }
            end
            local function fill(list)
                for i = ROLE_MIN, ROLE_MAX do list[i] = MakeColor(ROLE_COLORS) end
            end
            fill(ROLE_COLORS)
        "#,
        );
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_rhs_helper_param_shadow_stays_need_check_nil() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
            r#"
            ...
            ---@param MakeColor fun(): table
            local function fill(list, MakeColor)
                for i = ROLE_MIN, ROLE_MAX do
                    list[i] = MakeColor()
                end
            end
    ...
    #[gtest]
    fn test_outer_numeric_range_population_fill_param_shadow_stays_need_check_nil() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
            r#"
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_rhs_helper_mutates_helper_stays_need_check_nil() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
            r#"
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_rhs_helper_mutates_key_stays_need_check_nil() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
            r#"
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_rhs_helper_nested_call_stays_need_check_nil() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
            r#"
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_rhs_helper_reassigned_stays_need_check_nil() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
            r#"
            ...
            ROLE_TRAITOR = 2
            ROLE_COLORS = {}
            local function MakeColor() return { r = 1 } end
            local function fill(list)
                for i = ROLE_MIN, ROLE_MAX do list[i] = MakeColor() end
            end
            MakeColor = function() return nil end
            fill(ROLE_COLORS)
        "#,
        );
        let reader = ws.def_file(
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_dynamic_rhs_call_target_stays_need_check_nil() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
            r#"
            ...
            ROLE_COLORS = {}
            local makers = {}
            makers.MakeColor = function() return { r = 1 } end
            local function fill(list)
                for i = ROLE_MIN, ROLE_MAX do list[i] = makers.MakeColor() end
            end
            fill(ROLE_COLORS)
        "#,
        );
    ...
    #[gtest]
    fn test_cross_file_numeric_range_population_string_key_collision_stays_need_check_nil() {
        let mut ws = gmod_ws();
        ws.def_file(
            "lua/autorun/shared/sh_colors.lua",
            "ROLE_TRAITOR = 1\nROLE_COLORS = {}\nROLE_COLORS['1'] = { r = 1 }\nROLE_COLORS['#1'] = { r = 1 }",
    ...
    #[gtest]
    fn test_direct_server_only_valid_guard_does_not_suppress_client_nil_check() {
        let mut ws = VirtualWorkspace::new_with_init_std_lib();
        let mut emmyrc = Emmyrc::default();
        emmyrc.gmod.enabled = true;
        ws.update_emmyrc(emmyrc);
