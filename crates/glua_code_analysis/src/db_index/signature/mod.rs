...
pub use gmod_domains::{
    ...
    GMOD_DOMAIN_VGUI_PANEL, GMOD_ROLE_EXISTS, GMOD_ROLE_REFERENCE, GMOD_ROLE_VGUI_CHILD_SELF,
    GMOD_ROLE_VGUI_PARENT, GMOD_ROLE_VGUI_PARENT_SELF, GMOD_SIGNATURE_METADATA_DOMAINS,
