...
use glua_code_analysis::{InferGuard, LuaMemberKey, LuaType, SemanticModel};
use glua_parser::{LuaAst, LuaAstNode, LuaAstToken, LuaVarExpr};
use lsp_types::Uri;
...
fn build_func_override_gutter_info(
    ...
    func_stat: glua_parser::LuaFuncStat,
) -> Option<()> {
...
pub async fn on_emmy_gutter_detail_handler(
    ...
    let type_id = glua_code_analysis::LuaTypeDeclId::global(&type_name);
