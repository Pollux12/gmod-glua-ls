...
Default path-based realm rules are based on Garry's Mod's usual loading conventions (or very similar patterns). See [Lua Loading Order](https://wiki.facepunch.com/gmod/Lua_Loading_Order) for reference.
