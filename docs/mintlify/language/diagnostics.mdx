...
| Code | Default | Description |
|---|---|---|
| `gmod-realm-mismatch` | Warning | Calling a realm-specific function from the wrong realm |
| `gmod-realm-mismatch-heuristic` | Warning | Likely realm mismatch based on inferred evidence |
