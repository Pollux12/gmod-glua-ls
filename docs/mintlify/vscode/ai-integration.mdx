...
```
You: What arguments does Entity:TakeDamageInfo accept?

Copilot: [uses gluaDocs] Entity:TakeDamageInfo accepts one CTakeDamageInfo value.
```

```
You: Run print(game.GetMap()) on the server

Copilot: [uses gmodRunLua] Output: gm_flatgrass
```
