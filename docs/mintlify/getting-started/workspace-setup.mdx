...
Each folder has its own `.gluarc.json`, and the language server analyzes each one separately. Settings, diagnostics, and file param defaults stay scoped to that folder.
