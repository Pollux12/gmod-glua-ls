...
1. **gm_rdb** — a Garry's Mod binary module loaded by the SRCDS process. This is used to interact with the game engine and exposes a TCP debug endpoint for the extension.
