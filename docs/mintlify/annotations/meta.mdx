...
Use this for meta libraries, including the wiki-generated Garry's Mod annotations ([stable](https://github.com/Pollux12/annotations-gmod-glua-ls/tree/gluals-annotations), [pre-release](https://github.com/Pollux12/annotations-gmod-glua-ls/tree/gluals-annotations-prerelease)).
