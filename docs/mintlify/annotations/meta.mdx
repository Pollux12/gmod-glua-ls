...
Use this for meta libraries, including the wiki-generated Garry's Mod annotations downloaded by the VS Code extension ([view them here](https://github.com/Pollux12/annotations-gmod-glua-ls/tree/gluals-annotations)).
