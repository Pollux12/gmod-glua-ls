...
`@cast` forces GLuaLS to treat a variable as a specific type from that point forward in the code flow. Use it to narrow union types, assert non-nil values, or override inferred types in complex dynamic scenarios.
