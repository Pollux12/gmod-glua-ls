...
Annotations have no impact on runtime and are seen as regular comments by Garry's Mod — they are purely for the language server and documentation. Annotations help the language server understand your code better by giving it accurate data, saving it from expensive calculations and guesswork to infer types on its own, and allowing for richer editor features.
