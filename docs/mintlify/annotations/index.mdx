...
GLuaLS follows EmmyLua-style annotations and adds support for GMod-specific cases. It keeps compatibility with EmmyLua and LuaLS where possible.
...
| [`@call_arg`](/annotations/call-arg) | Mark wrapper parameters as GMod names or callbacks | `---@[call_arg("gmod.hook", "add")]` |
