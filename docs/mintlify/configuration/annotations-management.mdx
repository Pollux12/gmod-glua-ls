...
GLuaLS loads these API definitions before other library folders. This lets framework and addon libraries use Garry's Mod types and wrapper behavior correctly.
...
| `gluals.gmod.autoCheckAnnotationUpdates` | `true` | Check for annotation updates in the background |
| `gluals.gmod.annotationUpdateCheckIntervalMinutes` | `60` | Minutes between background update checks |
...
| VS Code setting | .gluarc.json key | Default | Description |
|---|---|---|---|
