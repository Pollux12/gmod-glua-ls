...
| `hint.enumParamHint` | `boolean` | `true` | Show enum member names next to literal integer arguments |
...
| `gluals.hint.enumParamHint` | `hint.enumParamHint` | `boolean` | `true` | Enum parameter name hints |
