...
By default, auto-save is disabled, to prevent you from accidentally overwriting settings. To save, click the **Save** button in the bottom left after making changes. This allows you to review multiple changes before saving.
...
| `gluals.decorations.*` | `boolean` | `false` | Underline decorations for globals, mutable locals/params, readonly locals/params |
| `gluals.source.roots` | `array` | `[]` | Additional source roots for the debugger |
