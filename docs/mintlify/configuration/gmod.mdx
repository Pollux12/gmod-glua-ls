---
title: "Garry's Mod Settings"
description: Language server settings for realm analysis, scripted classes, networking, VGUI, and annotations.
---
...
| Option | Type | Default | Description |
|---|---|---|---|
| `gmod.annotationsPath` | `string \| null` | `null` | Custom path to Garry's Mod annotation `.lua` files. When `null`, the VSCode extension's auto-downloaded annotations are used |
...
Built-in groups: `entities`, `weapons`, `effects`, `stools`, `player_classes`, `plugins`, `gamemodes`.
